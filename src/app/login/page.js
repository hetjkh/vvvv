      ...
      >
        <Card className="w-full max-w-md border-4 border-black shadow-[8px_8px_0_0_#000] bg-yellow-200">
          <CardHeader className="space-y-1 text-center border-b-4 border-black">
            ...
            <CardTitle className="text-3xl font-extrabold text-black">Welcome Back</CardTitle>
            <p className="text-gray-600">Sign in to discover your perfect match</p>
          </CardHeader>
          ...
          <CardContent className="p-6">
              ...
              >
                <div className="flex items-center justify-between">
                  ...
                  <a
                    ...
                    className="text-sm text-pink-600 hover:text-pink-800 transition-colors font-medium"
                  >
                    Forgot password?
                  </a>
                </div>
            ...
            <div className="relative my-6">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="bg-yellow-200 px-2 text-black font-bold">or continue with</span>
              </div>
            </div>
          ...
          >
            <p className="text-sm text-black font-bold">
              ...
              <a href="/register" className="text-pink-600 hover:text-pink-800 transition-colors font-bold">
                Sign up
              </a>
            </p>
          </motion.div>
